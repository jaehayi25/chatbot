...
function getResponse(percents) {
	...
	if (response == "Sure, how?" || response == "Ok. What should I bring?" || response == "How will I play?" || response == "What should I bring?" || response == "How will I get there?" || response == "What should we do there?" || response == "Alright! Where we partying?") {
